...
def search_wikipedia(query: str) -> str:
    """Look up encyclopaedic information on Wikipedia. Use for historical facts,
...
tools = [search_web, search_wikipedia, get_current_date]
...
3. If a question asks about something after 2024, use search_web, not search_wikipedia.
...
def run_agent_with_trace(user_input: str, session_id: str) -> tuple:
    ...
    try:
        ...
        final_answer = (
            "I couldn't finish within the step limit. "
